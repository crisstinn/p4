package com.pract4.demo.controller;

import com.pract4.demo.model.Animal;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;

import java.util.*;

@RestController public class AnimalController
{
    private final Map<String, Animal> animales = new HashMap<>(); //diccionario con el nombre del animal como clave y valor el objeto animal que tengo en el model

    //hago un endpoint que sea para crear animales nuevos segun las peticiones y que emplee las clases y funciones definidas en el model
    @PostMapping("/api/animales")
